...
| notes | `.ai/notes/README.md` | "set up notes vault", "scaffold my second brain", capture verbs ("capture to inbox", "log to daily", "process inbox"), "what do I know about …", "new bug ticket …", editing under `notes/`. Viewer setup ("set up Obsidian for my notes") → `.ai/notes/adapters/<viewer>/README.md`. |
