...
- `.ai/adapters/<platform>/` — any rule that's platform-specific but applies to all platforms now?
...
- `.ai/adapters/claude/agents/dream-worker.md` — Claude subagent implementation.
- `.ai/adapters/kiro/agents/dream-worker.md` — Kiro subagent implementation.
- `.ai/adapters/claude/commands/dream.md` — `/dream` slash command wiring.
