...
- `.ai/nova-skills/adapters/<platform>/` — any rule that's platform-specific but applies to all platforms now?
...
- `.ai/nova-skills/adapters/claude/agents/dream-worker.md` — Claude subagent implementation.
- `.ai/nova-skills/adapters/kiro/agents/dream-worker.md` — Kiro subagent implementation.
- `.ai/nova-skills/adapters/claude/commands/dream.md` — `/dream` slash command wiring.
