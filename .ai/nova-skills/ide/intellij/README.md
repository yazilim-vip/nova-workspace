...
Implementation detail of `nova-ide` — generates IntelliJ project config (`.idea/`) from the NOVA workspace's cloned repos and optionally registers run configurations. Loaded on demand by the parent skill at `.ai/nova-skills/ide/SKILL.md`.
