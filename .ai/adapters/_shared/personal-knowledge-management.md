...
| `.ai/personal-knowledge-management/` | Read for context. Edit only when the user asks to evolve the contract or an adapter — that's a framework change, not PKM use. |
