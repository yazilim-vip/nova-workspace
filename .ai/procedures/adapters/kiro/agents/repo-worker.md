...
Before any shell command, honour `.ai/procedures/adapters/kiro/terminal.md` — the terminal rules are strict. No heredocs, one command per execution, scripts in `scripts/` for multi-step logic. If the terminal hangs, stop and surface it.
